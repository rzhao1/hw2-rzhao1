...
//        System.out.println("The iscorrect is"+docText.substring(matcher.start()+2, matcher.start()+3));
 //       System.out.println("answer is "+answer.getCoveredText());
        if(docText.substring(answermatcher.start()+2, answermatcher.start()+3).trim().equals("1")){
